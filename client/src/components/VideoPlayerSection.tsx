...
export default function VideoPlayerSection({ autoPlay }: VideoPlayerSectionProps) {
  return (
    <section id="video" className="bg-gray-800 rounded-lg p-6 shadow-lg mb-8">
      ...
      <div className="aspect-video bg-black rounded flex items-center justify-center text-gray-400">
        <video data-testid="video-player" className="w-full h-full" controls autoPlay={autoPlay} />
      </div>
