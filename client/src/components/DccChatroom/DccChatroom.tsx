...
export default function DccChatroom({ peer, onClose, onSendFile, onPlayback, incomingOffer }: DccChatroomProps) {
  ...
  function onFileChosen(file: File) {
    ...
    invoke('dcc_file_offer', { toIp: peer!.ip, toPort: peer!.port, name: file.name, size: file.size }).catch((e) => {
